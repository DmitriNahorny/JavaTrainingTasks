...
import by.nahorny.task5.calculation.LexemeSorting;
 ...
 */
public class LexemeSortingTest {
    ...
    static final Logger LOGGER = LogManager.getLogger(LexemeSortingTest.class);
    ...
    public void testLexemeSorting() {
        ...
        LexemeSorting lexemeSorting = new LexemeSorting();
        lexemeSorting.sortText(textComposite);
