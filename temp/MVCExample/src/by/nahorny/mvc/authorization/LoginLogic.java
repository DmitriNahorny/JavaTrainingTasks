...
public class LoginLogic {
    ...
    public static User checkLogin(String enterLogin, String enterPass) throws UnavailableConnectionException, DAOException {
    ...
    static String convertToMD5(String input, String salt) {
